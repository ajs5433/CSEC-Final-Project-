...
class Ui_beforeStarting(object):
    def setupUi(self, beforeStarting):
        ...
        self.label_5.setGeometry(QtCore.QRect(110, 220, 491, 51))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Century Gothic"))
        font.setPointSize(12)
        ...
        self.pushButton.setGeometry(QtCore.QRect(630, 370, 71, 31))
    ...
    def retranslateUi(self, beforeStarting):
        ...
        self.label_3.setText(_translate("beforeStarting", "- You will be given a PIN NUMBER", None))
        self.label_4.setText(_translate("beforeStarting", "- You will be given SYMBOLS", None))
        self.label_5.setText(_translate("beforeStarting", "- You will be given a SENTENCE with a famous character", None))
