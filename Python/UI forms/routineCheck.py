...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.passwordCheck_le = QtGui.QLineEdit(Dialog)
        self.passwordCheck_le.setGeometry(QtCore.QRect(90, 130, 181, 20))
        self.passwordCheck_le.setObjectName(_fromUtf8("passwordCheck_le"))
        self.checkBox = QtGui.QCheckBox(Dialog)
        self.checkBox.setGeometry(QtCore.QRect(50, 130, 21, 17))
