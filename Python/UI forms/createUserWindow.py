...
class Ui_createUserWindow(object):
    def setupUi(self, createUserWindow):
        ...
        createUserWindow.resize(282, 365)
        ...
        self.label.setGeometry(QtCore.QRect(60, 140, 31, 16))
        self.label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label.setObjectName(_fromUtf8("label"))
        self.name_tb = QtGui.QPlainTextEdit(createUserWindow)
        self.name_tb.setGeometry(QtCore.QRect(100, 140, 121, 21))
        self.name_tb.setObjectName(_fromUtf8("name_tb"))
        self.lastName_tb = QtGui.QPlainTextEdit(createUserWindow)
        self.lastName_tb.setGeometry(QtCore.QRect(100, 190, 121, 21))
        self.lastName_tb.setObjectName(_fromUtf8("lastName_tb"))
        ...
        self.passwordType_cb.setGeometry(QtCore.QRect(100, 240, 121, 22))
        ...
        self.label_5 = QtGui.QLabel(createUserWindow)
        self.label_5.setGeometry(QtCore.QRect(60, 80, 161, 31))
    ...
    def retranslateUi(self, createUserWindow):
        ...
        self.passwordType_cb.setItemText(0, _translate("createUserWindow", "Testing Password 1", None))
        self.passwordType_cb.setItemText(1, _translate("createUserWindow", "Testing Password 2", None))
        self.passwordType_cb.setItemText(2, _translate("createUserWindow", "Testing Password 3", None))
        self.passwordType_cb.setItemText(3, _translate("createUserWindow", "Gmail", None))
        self.passwordType_cb.setItemText(4, _translate("createUserWindow", "Facebook", None))
        self.passwordType_cb.setItemText(5, _translate("createUserWindow", "Slack", None))
